...
function matchAnswer(selectedAnswer) {
    ...
    if (selectedAnswer === correctAnswer) {
        ...
        scoreMessage = `<p style="color: red;">Incorrect! The correct answer is: ${correctAnswer}. Total: ${currentPlayer === 0 ?
...
document.getElementById('submit-btn').addEventListener('click', winnerResult);